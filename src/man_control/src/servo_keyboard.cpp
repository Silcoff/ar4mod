...
const std::string EE_FRAME_ID = "ee_link";
}  // namespace
...
KeyboardServo::KeyboardServo() : joint_vel_cmd_(1.0), command_frame_id_{ "link_1" }
{
...
int KeyboardServo::keyLoop()
{
  ...
  for (;;)
  {
    ...
    joint_msg->joint_names = { "joint_1", "joint_2", "joint_3", "joint_4",
                               "joint_5", "joint_6" };
